...
class ReportaController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const reportas = yield database_1.default.query("SELECT pro_id, name_pro, acronym_product, Date_format(created_at, '%Y-%m-%d T %h:%i') AS created_at FROM reporta");
            res.json(reportas);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const reporta = yield database_1.default.query("SELECT pro_id, name_pro, acronym_product, Date_format(created_at, '%Y-%m-%dT%h:%i') AS created_at FROM reporta = ?", [idd]);
            if (reporta.length > 0) {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const insert = yield database_1.default.query('INSERT INTO reporta set ?', [req.body]);
            if (insert) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { idd } = req.params;
            const actualizar = yield database_1.default.query('UPDATE reporta set ? WHERE pro_id = ?', [req.body, idd]);
            if (actualizar) {
